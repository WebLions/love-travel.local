	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body"> <!-- Пофиксиить текст под заказчика-->
	       Настоящим я даю разрешение web-сервису «Конструктор договоров» получать, систематизировать, накапливать, хранить, уточнять (обновлять, изменять) и иным образом обрабатывать мои персональные данные, размещаемые мною на сайте 74nedvizhimost.ru. Целями обработки персональных данных могут быть: 1. Генерация, по моему запросу, текста договора купли-продажи квартиры и предварительного договора купли-продажи квартиры, для использования в моих частных интересах, и не подлежащего распространению в необезличенном виде. 2. Обеспечение возможности обратной связи с администрацией сайта 74nedvizhimost.ru. Согласие дается на срок размещения персональных данных на Сайте. Я подтверждаю, что разрешаю web-сервису «Конструктор договоров» направлять мне корреспонденцию на указанный мной адрес электронной почты и\или на указанный мной номер телефона. Я уведомлен (-а), что генерация документов происходит на моем компьютере, а мои персональные данные не будут отправлены на сервера Сайта, и не смогут быть доступны кому-либо.
	      </div>
